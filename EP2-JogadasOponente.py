...
# Jogadas do Oponente   
    lista_linhacoluna_anterior = []
    linhacoluna_oponente_invalida = True
    while linhacoluna_oponente_invalida:
        linha_oponente = random.randint(0,9)
        coluna_oponente = random.randint(0,9)

        lista_linhacoluna = [linha_oponente,coluna_oponente]

        if lista_linhacoluna not in lista_linhacoluna_anterior:
            lista_linhacoluna_anterior.append(lista_linhacoluna)
            linhacoluna_oponente_invalida = False
            print('Seu oponente está atacando na linha {} e coluna {}'.format(linha_oponente,coluna_oponente))

            novo_tabuleiro = faz_jogada(tabuleiro,linha_oponente,coluna_oponente)
